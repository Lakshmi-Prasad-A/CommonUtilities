package com.insignia.stringConstant;

public class ValidatorConstants {
	public static final String validUserId= "Please enter userid";
	public static final String validUserIdErrorCode= "300";
	public static final String validUserIdLength = "Please enter userid length upto 30 characters only";
	...
	/*
	 * public static final String validPassword= "Please enter password"; public
	 * static final String validPasswordErrorCode= "309"; public static final String
	 * validPasswordLength = "Please enter password length upto 30 characters only";
	 * public static final String validPasswordLengthErrorCode= "310"; public static
	 * final String validPasswordExpression =
	 * "Please provide valid password, the allowed characters are [ A-Z, a-z, 0-9, _, -, .] only"
